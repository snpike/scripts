...
pfile = open('/Volumes/LaCie/CdTe/gammaFlood/20170315_H100_gamma_Am241_-10C_dump.0V.pkl', 'rb')
...
for x in range(32):
	for y in range(32):
		...
		plt.xlabel('Channel')
		plt.ylabel('Counts')
		plt.savefig('/Volumes/LaCie/CdTe/gammaFlood/images/pixelSpectraAm/20170315_H100_gamma_Am241_-10C_x' + str(x) + '_y' + str(y) +'_spectrum.0V.eps')
		plt.close()
'''
images = [[imgio.imread('/Volumes/LaCie/CdTe/gammaFlood/images/pixelSpectraAm/20170315_H100_gamma_Am241_-10C_x' + str(j) + '_y' + str(i) +'_spectrum.0V.eps') for j in range(32)] for i in range(32)]
