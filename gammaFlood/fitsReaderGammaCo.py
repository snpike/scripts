...
file = fits.open('/Users/sean/CdTe/gammaFlood/20170313_H100_gamma_Co57_-10C.0V.fits')
data = file[1].data
file.close()
START = 0
i = 0
...
pickle.dump(events, open('/Users/sean/CdTe/gammaFlood/20170313_H100_gamma_Co57_-10C_x20_y10_dump.0V.pkl', 'wb'))
...
'''
events = pickle.load(open('/Users/sean/CdTe/gammaFlood/20170313_H100_gamma_Co57_-10C_x20_y10_dump.0V.pkl', 'rb'))
print(len(events['channel']))
'''
...
plt.xlabel('Channel')
plt.ylabel('Counts')
plt.savefig('/Users/sean/CdTe/gammaFlood/images/20170313_H100_gamma_Co57_-10C_x20_y10_spectrum.0V.eps')
plt.close()
...
plt.savefig('/Users/sean/CdTe/gammaFlood/images/20170313_H100_gamma_Co57_-10C_spectrum_keV.0V.eps')
plt.close()
...
plt.xlabel('Energy (keV)')
plt.ylabel('Normalized Counts')
plt.savefig('/Users/sean/CdTe/gammaFlood/images/20170313_H100_gamma_Co57_-10C_fit_HIGH_keV.0V.eps')
plt.close()
...
plt.savefig('/Users/sean/CdTe/gammaFlood/images/20170313_H100_gamma_Co57_-10C_heatmap_40-70keV.0V.eps')
plt.close()

plt.hist(pixelMap.flatten(), bins = 30, histtype = 'step')
plt.xlabel('Counts')
plt.ylabel('Pixels')
plt.savefig('/Users/sean/CdTe/gammaFlood/images/20170313_H100_gamma_Co57_-10C_pixelHistogram_40-70keV.0V.eps')
plt.close()'''
